...
class Network(gluon.HybridBlock):
    ...
    def __init__(self, num_downsamples=2, resnet_layer_id=4, rnn_hidden_states=200, rnn_layers=1, max_seq_len=100, ctx=mx.cpu(0), **kwargs):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-g", "--gpu_id", default="-1",
